...
public class ClientResponseModel {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ClientResponseModel.class);
    ...
    public ClientResponseModel(List<NameValuePair> cookies, String html, String referer) {
        this.cookies = cookies;
        this.html = html;
        this.referer = referer;
    }

    public ClientResponseModel(String html, String referer) {
        this.html = html;
        this.referer = referer;
    }
