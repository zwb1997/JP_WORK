...
public class HttpClientUtil {
    ...
    private static final RequestConfig REQUEST_CONFIG = RequestConfig.custom().setResponseTimeout(Timeout.ofSeconds(10))
            ...
            .setConnectionKeepAlive(TimeValue.ofSeconds(60)).setProxy(PROXY_HOST).build();
     ...
     */
    public static ClientResponseModel requestWithContext(List<NameValuePair> headers, HttpUriRequest httpType,
        ...
        ClientResponseModel clientUtilModel = null;
        ...
        clientUtilModel = new ClientResponseModel(cookies, resHtml, httpType.getRequestUri());
        return clientUtilModel;
    }

    /**
     * execute request simply
     * 
     * @param headers
     * @param httpType
     * @param useHtml
     * @return
     */
    public static ClientResponseModel requestSimply(List<NameValuePair> headers, HttpUriRequest httpType,
            boolean useHtml) {
        LOG.info("begin request...");
        Assert.notNull(httpType, "httpType cannot empty!");
